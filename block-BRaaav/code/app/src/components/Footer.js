        ...
        <div className="flex align-start">
          ...
          <div className="flex-20">
            ...
            <nav>
              <ul>
                <li>
                  <a href="www.github.com">About us</a>
                </li>
                <li>
                  <a href="www.github.com">Join our team</a>
                </li>
                <li>
                  <a href="www.github.com">Read blog</a>
                </li>
                <li>
                  <a href="www.github.com">Press</a>
                </li>
              </ul>
            </nav>
          </div>
          <div className="flex-20">
            ...
            <nav>
              <ul>
                <li>
                  <a href="www.github.com">Pricing</a>
                </li>
                <li>
                  <a href="www.github.com">Documentation</a>
                </li>
                <li>
                  <a href="www.github.com">Support</a>
                </li>
              </ul>
            </nav>
          </div>
